...
class ForgotPasswordControllerPhoneInLogin extends GetxController{
  ...
  Future<void> sendOtpForForget() async {
    ...
    try{
      ...
      if (response.status == true) {
        ...
        Get.toNamed(Routes.forgotOtpVerifyInLogin,arguments: {"phone":phoneController.text,"countryCode":countryString.value,} );
      } else if(response.status == false && response.type == 'failed'){
