              ...
              Obx(() {
                return controller.isLoading.value
                    ...
                    ListView.separated(
                      ...
                      shrinkWrap: true,
                      itemBuilder: (context, index) {
                        print("id-----------s${controller.ids}");
                        var isSelected =
                            index == controller.selectedPaymentMethod.value;
                        if(controller.ids.contains(controller
                            .paymentData
                            .value
                            .data?[index].id) || controller.paymentData.value.data?[index].id==3){
                        ...
                        return InkWell(
                          onTap: () {
                            ...
                            controller.methodId.value =
                                "${controller.paymentData.value.data?[index].id ?? 0}";
  ...
  Widget bankDetailsForm() {
    return Form(
      ...
      child: SingleChildScrollView(
        child: Obx(() {
          return controller.methodId.value == "4"
              ? Column(
                children: [
                  WidgetDesigns.hBox(20),
              ...
              ? Column(
                children: [
                    ...
                    builder: (context) {
                      return CustomTextFormField(
                        ...
                        validator: (value) {
                          ...
                          if (controller.bankNameError.value.isNotEmpty ||
                    ...
                    builder: (context) {
                      return CustomTextFormField(
                        ...
                        validator: (value) {
                          ...
                          if (controller.acNumberError.value.isNotEmpty ||
                              controller.acNumberError.value != '') {
                    ...
                    builder: (context) {
                      return CustomTextFormField(
                        ...
                        validator: (value) {
                          ...
                          if (controller.reTypeACError.value.isNotEmpty ||
                              controller.reTypeACError.value != '') {
                  ...
                  SimpleCustomDropdown(
                    ...
                    validator:
                        (value) => value == null ? 'Select Account type' : null,
                  ),
                    ...
                    builder: (context) {
                      return CustomTextFormField(
                        ...
                        validator: (value) {
                          ...
                          if (controller.ifscError.value.isNotEmpty ||
