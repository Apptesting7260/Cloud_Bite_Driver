class SignupWithoutVerifyModel {
  bool? status;
  String? type;
  String? message;
  Data? data;

  SignupWithoutVerifyModel({this.status, this.type, this.message, this.data});

  SignupWithoutVerifyModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    frontLicense = json['front_license'.toString()].toString();
  ...
  Map<String, dynamic> toJson() {
    ...
    data['order_otp'] = orderOtp;
    data['order_otp_expire'] = orderOtpExpire;
    data['wallet'] = wallet;
