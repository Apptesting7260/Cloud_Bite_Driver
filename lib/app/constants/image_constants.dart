class ImageConstants{
  ...
  static  String whatsappImage = "$imagePath/whatsapp.png";
  static  String emailImage = "$imagePath/email.png";
  ...
  static String facebookLoginImage= "$imagePath/fb.png";
  ...
  static String noDataFoundJson = '$jsonPath/nodatafound_updated.json';
}